...
pub const CURATED_ALIASES: &[(&str, &str, u8, [&str; 5])] = &[
    ...
    ("person", "prenu", 1, ["", "", "", "", ""]),
    // KR test-corpus vocabulary pinned at THE DROP (the fail-closed front-end
    // needs every shipped-corpus/test word resolvable in the fallback build;
    // spellings match the full-mode generated aliases already in use).
    ("friend", "pendo", 2, ["", "befriended", "", "", ""]),
    ("be_hungry", "xagji", 2, ["", "food", "", "", ""]),
    ("bite", "batci", 4, ["biter", "bitten", "locus", "tool", ""]),
    ("apple", "plise", 2, ["", "species", "", "", ""]),
    ("shape", "tarmi", 2, ["", "object", "", "", ""]),
    (
        "promise",
        "nupre",
        3,
        ["promiser", "promised", "beneficiary", "", ""],
    ),
    ("exact", "satci", 3, ["", "precision", "quality", "", ""]),
    ("address", "judri", 3, ["", "addressee", "system", "", ""]),
    (
        "believe",
        "krici",
        3,
        ["believer", "creed", "subject", "", ""],
    ),
    ("empty", "kunti", 2, ["", "material", "", "", ""]),
    ("religion", "lijda", 3, ["", "believers", "tenets", "", ""]),
    ("shelter", "marbi", 3, ["", "protected", "danger", "", ""]),
    ("nation", "natmi", 2, ["", "peoples", "", "", ""]),
    (
        "necessary",
        "sarcu",
        3,
