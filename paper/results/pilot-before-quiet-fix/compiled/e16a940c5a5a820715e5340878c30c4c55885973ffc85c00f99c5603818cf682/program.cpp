...
rel_p_animal_4aba00480e0edcd7(&rel_p_animal_4aba00480e0edcd7){
}
...
signalHandler->setMsg(R"_(answer(0) :- 
   p_animal("Ada").
in file input.dl [9:1-9:30])_");
if(!(rel_p_animal_4aba00480e0edcd7->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_answer_227ae7ad3b0ead1f_op_ctxt,rel_answer_227ae7ad3b0ead1f->createContext());
CREATE_OP_CONTEXT(rel_p_animal_4aba00480e0edcd7_op_ctxt,rel_p_animal_4aba00480e0edcd7->createContext());
if(rel_p_animal_4aba00480e0edcd7->contains(Tuple<RamDomain,1>{{ramBitCast(RamSigned(0))}},READ_OP_CONTEXT(rel_p_animal_4aba00480e0edcd7_op_ctxt))) {
...
signalHandler->setMsg(R"_(answer(1) :- 
   p_animal("Bea").
in file input.dl [10:1-10:30])_");
if(!(rel_p_animal_4aba00480e0edcd7->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_answer_227ae7ad3b0ead1f_op_ctxt,rel_answer_227ae7ad3b0ead1f->createContext());
CREATE_OP_CONTEXT(rel_p_animal_4aba00480e0edcd7_op_ctxt,rel_p_animal_4aba00480e0edcd7->createContext());
if(rel_p_animal_4aba00480e0edcd7->contains(Tuple<RamDomain,1>{{ramBitCast(RamSigned(1))}},READ_OP_CONTEXT(rel_p_animal_4aba00480e0edcd7_op_ctxt))) {
...
signalHandler->setMsg(R"_(answer(2) :- 
   p_animal("Cyd").
in file input.dl [11:1-11:30])_");
if(!(rel_p_animal_4aba00480e0edcd7->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_answer_227ae7ad3b0ead1f_op_ctxt,rel_answer_227ae7ad3b0ead1f->createContext());
CREATE_OP_CONTEXT(rel_p_animal_4aba00480e0edcd7_op_ctxt,rel_p_animal_4aba00480e0edcd7->createContext());
if(rel_p_animal_4aba00480e0edcd7->contains(Tuple<RamDomain,1>{{ramBitCast(RamSigned(2))}},READ_OP_CONTEXT(rel_p_animal_4aba00480e0edcd7_op_ctxt))) {
...
if (pruneImdtRels) rel_p_animal_4aba00480e0edcd7->purge();
}
...
namespace  souffle {
using namespace souffle;
class Stratum_p_animal_5fcce07716ba38ec {
public:
 Stratum_p_animal_5fcce07716ba38ec(SymbolTable& symTable,RecordTable& recordTable,ConcurrentCache<std::string,std::regex>& regexCache,bool& pruneImdtRels,bool& performIO,SignalHandler*& signalHandler,std::atomic<std::size_t>& iter,std::atomic<RamDomain>& ctr,std::string& inputDirectory,std::string& outputDirectory,t_btree_000_i__0__1::Type& rel_p_animal_4aba00480e0edcd7,t_btree_000_i__0__1::Type& rel_p_cat_ad8a6a5faaa6cbe8,t_btree_000_i__0__1::Type& rel_p_dog_b5b972c6324533a4);
void run([[maybe_unused]] const std::vector<RamDomain>& args,[[maybe_unused]] std::vector<RamDomain>& ret);
private:
SymbolTable& symTable;
RecordTable& recordTable;
...
namespace  souffle {
using namespace souffle;
 Stratum_p_animal_5fcce07716ba38ec::Stratum_p_animal_5fcce07716ba38ec(SymbolTable& symTable,RecordTable& recordTable,ConcurrentCache<std::string,std::regex>& regexCache,bool& pruneImdtRels,bool& performIO,SignalHandler*& signalHandler,std::atomic<std::size_t>& iter,std::atomic<RamDomain>& ctr,std::string& inputDirectory,std::string& outputDirectory,t_btree_000_i__0__1::Type& rel_p_animal_4aba00480e0edcd7,t_btree_000_i__0__1::Type& rel_p_cat_ad8a6a5faaa6cbe8,t_btree_000_i__0__1::Type& rel_p_dog_b5b972c6324533a4):
symTable(symTable),
recordTable(recordTable),
regexCache(regexCache),
pruneImdtRels(pruneImdtRels),
...
outputDirectory(outputDirectory),
rel_p_animal_4aba00480e0edcd7(&rel_p_animal_4aba00480e0edcd7),
rel_p_cat_ad8a6a5faaa6cbe8(&rel_p_cat_ad8a6a5faaa6cbe8),
rel_p_dog_b5b972c6324533a4(&rel_p_dog_b5b972c6324533a4){
}

void Stratum_p_animal_5fcce07716ba38ec::run([[maybe_unused]] const std::vector<RamDomain>& args,[[maybe_unused]] std::vector<RamDomain>& ret){
signalHandler->setMsg(R"_(p_animal(X) :- 
   p_dog(X),
   !p_cat(X).
in file input.dl [6:1-6:36])_");
if(!(rel_p_dog_b5b972c6324533a4->empty())) {
[&](){
CREATE_OP_CONTEXT(rel_p_animal_4aba00480e0edcd7_op_ctxt,rel_p_animal_4aba00480e0edcd7->createContext());
CREATE_OP_CONTEXT(rel_p_cat_ad8a6a5faaa6cbe8_op_ctxt,rel_p_cat_ad8a6a5faaa6cbe8->createContext());
CREATE_OP_CONTEXT(rel_p_dog_b5b972c6324533a4_op_ctxt,rel_p_dog_b5b972c6324533a4->createContext());
for(const auto& env0 : *rel_p_dog_b5b972c6324533a4) {
if( !(rel_p_cat_ad8a6a5faaa6cbe8->contains(Tuple<RamDomain,1>{{ramBitCast(env0[0])}},READ_OP_CONTEXT(rel_p_cat_ad8a6a5faaa6cbe8_op_ctxt)))) {
Tuple<RamDomain,1> tuple{{ramBitCast(env0[0])}};
rel_p_animal_4aba00480e0edcd7->insert(tuple,READ_OP_CONTEXT(rel_p_animal_4aba00480e0edcd7_op_ctxt));
}
}
}
();}
if (pruneImdtRels) rel_p_cat_ad8a6a5faaa6cbe8->purge();
...
namespace  souffle {
using namespace souffle;
class Stratum_p_cat_44c3eca583e764f1 {
public:
 Stratum_p_cat_44c3eca583e764f1(SymbolTable& symTable,RecordTable& recordTable,ConcurrentCache<std::string,std::regex>& regexCache,bool& pruneImdtRels,bool& performIO,SignalHandler*& signalHandler,std::atomic<std::size_t>& iter,std::atomic<RamDomain>& ctr,std::string& inputDirectory,std::string& outputDirectory,t_btree_000_i__0__1::Type& rel_p_cat_ad8a6a5faaa6cbe8);
void run([[maybe_unused]] const std::vector<RamDomain>& args,[[maybe_unused]] std::vector<RamDomain>& ret);
private:
SymbolTable& symTable;
RecordTable& recordTable;
...
namespace  souffle {
using namespace souffle;
 Stratum_p_cat_44c3eca583e764f1::Stratum_p_cat_44c3eca583e764f1(SymbolTable& symTable,RecordTable& recordTable,ConcurrentCache<std::string,std::regex>& regexCache,bool& pruneImdtRels,bool& performIO,SignalHandler*& signalHandler,std::atomic<std::size_t>& iter,std::atomic<RamDomain>& ctr,std::string& inputDirectory,std::string& outputDirectory,t_btree_000_i__0__1::Type& rel_p_cat_ad8a6a5faaa6cbe8):
symTable(symTable),
recordTable(recordTable),
regexCache(regexCache),
pruneImdtRels(pruneImdtRels),
...
void Stratum_p_cat_44c3eca583e764f1::run([[maybe_unused]] const std::vector<RamDomain>& args,[[maybe_unused]] std::vector<RamDomain>& ret){
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{R"_(IO)_",R"_(file)_"},{R"_(attributeNames)_",R"_(a0)_"},{R"_(auxArity)_",R"_(0)_"},{R"_(fact-dir)_",R"_(.)_"},{R"_(name)_",R"_(p_cat)_"},{R"_(operation)_",R"_(input)_"},{R"_(params)_",R"_({"records": {}, "relation": {"arity": 1, "params": ["a0"]}})_"},{R"_(types)_",R"_({"ADTs": {}, "records": {}, "relation": {"arity": 1, "types": ["s:symbol"]}})_"}});
if (!inputDirectory.empty()) {directiveMap["fact-dir"] = inputDirectory;}
IOSystem::getInstance().getReader(directiveMap, symTable, recordTable)->readAll(*rel_p_cat_ad8a6a5faaa6cbe8);
} catch (std::exception& e) {std::cerr << "Error loading p_cat data: " << e.what() << '\n';
exit(1);
}
}
}
...
ConcurrentCache<std::string,std::regex> regexCache;
Own<t_btree_000_i__0__1::Type> rel_p_cat_ad8a6a5faaa6cbe8;
souffle::RelationWrapper<t_btree_000_i__0__1::Type> wrapper_rel_p_cat_ad8a6a5faaa6cbe8;
...
Own<t_btree_000_i__0__1::Type> rel_p_animal_4aba00480e0edcd7;
souffle::RelationWrapper<t_btree_000_i__0__1::Type> wrapper_rel_p_animal_4aba00480e0edcd7;
...
Stratum_p_animal_5fcce07716ba38ec stratum_p_animal_ac45f1c4b1f3b0c4;
Stratum_p_cat_44c3eca583e764f1 stratum_p_cat_343dd9b5651c2123;
...
recordTable(),
regexCache(),
rel_p_cat_ad8a6a5faaa6cbe8(mk<t_btree_000_i__0__1::Type>()),
wrapper_rel_p_cat_ad8a6a5faaa6cbe8(0, *rel_p_cat_ad8a6a5faaa6cbe8, *this, "p_cat", std::array<const char *,1>{{"s:symbol"}}, std::array<const char *,1>{{"a0"}}, 0),
rel_p_dog_b5b972c6324533a4(mk<t_btree_000_i__0__1::Type>()),
wrapper_rel_p_dog_b5b972c6324533a4(1, *rel_p_dog_b5b972c6324533a4, *this, "p_dog", std::array<const char *,1>{{"s:symbol"}}, std::array<const char *,1>{{"a0"}}, 0),
rel_p_animal_4aba00480e0edcd7(mk<t_btree_000_i__0__1::Type>()),
wrapper_rel_p_animal_4aba00480e0edcd7(2, *rel_p_animal_4aba00480e0edcd7, *this, "p_animal", std::array<const char *,1>{{"s:symbol"}}, std::array<const char *,1>{{"a0"}}, 0),
rel_answer_227ae7ad3b0ead1f(mk<t_btree_000_i__0__1::Type>()),
wrapper_rel_answer_227ae7ad3b0ead1f(3, *rel_answer_227ae7ad3b0ead1f, *this, "answer", std::array<const char *,1>{{"i:number"}}, std::array<const char *,1>{{"i"}}, 0),
stratum_answer_2f35c27c80acc152(symTable,recordTable,regexCache,pruneImdtRels,performIO,signalHandler,iter,ctr,inputDirectory,outputDirectory,*rel_answer_227ae7ad3b0ead1f,*rel_p_animal_4aba00480e0edcd7),
stratum_p_animal_ac45f1c4b1f3b0c4(symTable,recordTable,regexCache,pruneImdtRels,performIO,signalHandler,iter,ctr,inputDirectory,outputDirectory,*rel_p_animal_4aba00480e0edcd7,*rel_p_cat_ad8a6a5faaa6cbe8,*rel_p_dog_b5b972c6324533a4),
stratum_p_cat_343dd9b5651c2123(symTable,recordTable,regexCache,pruneImdtRels,performIO,signalHandler,iter,ctr,inputDirectory,outputDirectory,*rel_p_cat_ad8a6a5faaa6cbe8),
...
addRelation("p_cat", wrapper_rel_p_cat_ad8a6a5faaa6cbe8, true, false);
addRelation("p_dog", wrapper_rel_p_dog_b5b972c6324533a4, true, false);
addRelation("p_animal", wrapper_rel_p_animal_4aba00480e0edcd7, false, false);
...
stratum_p_cat_343dd9b5651c2123.run(args, ret);
}
{
 std::vector<RamDomain> args, ret;
...
{
 std::vector<RamDomain> args, ret;
stratum_p_animal_ac45f1c4b1f3b0c4.run(args, ret);
}
{
 std::vector<RamDomain> args, ret;
...
rwOperation["name"] = "p_cat";
rwOperation["types"] = R"_({"relation": {"arity": 1, "auxArity": 0, "types": ["s:symbol"]}})_";
IOSystem::getInstance().getWriter(rwOperation, symTable, recordTable)->writeAll(*rel_p_cat_ad8a6a5faaa6cbe8);
} catch (std::exception& e) {std::cerr << e.what();exit(1);}
try {std::map<std::string, std::string> rwOperation;
rwOperation["IO"] = "stdout";
...
{
try{
souffle::CmdOptions opt(R"_(/home/dhilipsiva/projects/dhilipsiva/nibli/paper/results/pilot/inputs/1/input.dl)_",
R"_()_",
R"_()_",
false,
R"_()_",
