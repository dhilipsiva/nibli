...
if( rel_p_prevents_d66348ddd9bf0aaf->contains(Tuple<RamDomain,2>{{ramBitCast(RamSigned(5)),ramBitCast(env0[0])}},READ_OP_CONTEXT(rel_p_prevents_d66348ddd9bf0aaf_op_ctxt)) && rel_p_dangerous_d0dd5fbc04aa6c6a->contains(Tuple<RamDomain,3>{{ramBitCast(env0[2]),ramBitCast(env0[1]),ramBitCast(RamSigned(6))}},READ_OP_CONTEXT(rel_p_dangerous_d0dd5fbc04aa6c6a_op_ctxt))) {
Tuple<RamDomain,3> tuple{{ramBitCast(env0[0]),ramBitCast(RamSigned(7)),ramBitCast(env0[2])}};
...
for(const auto& env0 : *rel_p_carries_18ed98dca8dc70c1) {
if( rel_p_permits_bff897f9d6b85db2->contains(Tuple<RamDomain,3>{{ramBitCast(RamSigned(8)),ramBitCast(env0[0]),ramBitCast(RamSigned(9))}},READ_OP_CONTEXT(rel_p_permits_bff897f9d6b85db2_op_ctxt)) && rel_p_dangerous_d0dd5fbc04aa6c6a->contains(Tuple<RamDomain,3>{{ramBitCast(env0[2]),ramBitCast(env0[1]),ramBitCast(RamSigned(6))}},READ_OP_CONTEXT(rel_p_dangerous_d0dd5fbc04aa6c6a_op_ctxt))) {
Tuple<RamDomain,3> tuple{{ramBitCast(env0[0]),ramBitCast(RamSigned(7)),ramBitCast(env0[2])}};
rel_p_authorized_3b4f94c44af63fd0->insert(tuple,READ_OP_CONTEXT(rel_p_authorized_3b4f94c44af63fd0_op_ctxt));
}
}
...
CREATE_OP_CONTEXT(rel_p_warns_a31319bd838ae612_op_ctxt,rel_p_warns_a31319bd838ae612->createContext());
for(const auto& env0 : *rel_p_carries_18ed98dca8dc70c1) {
if( !(rel_p_authorized_3b4f94c44af63fd0->contains(Tuple<RamDomain,3>{{ramBitCast(env0[0]),ramBitCast(RamSigned(7)),ramBitCast(env0[2])}},READ_OP_CONTEXT(rel_p_authorized_3b4f94c44af63fd0_op_ctxt)))) {
...
stratum_answer_2f35c27c80acc152(symTable,recordTable,regexCache,pruneImdtRels,performIO,signalHandler,iter,ctr,inputDirectory,outputDirectory,*rel_answer_227ae7ad3b0ead1f,*rel_p_warns_a31319bd838ae612),
...
{
try{
souffle::CmdOptions opt(R"_(/home/dhilipsiva/projects/dhilipsiva/nibli/paper/results/evaluation/inputs/comparison-policy-1000-both-s11-d10-m1-verdict/input.dl)_",
R"_()_",
R"_()_",
false,
R"_()_",
