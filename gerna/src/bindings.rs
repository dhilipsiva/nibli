    ...
    pub mod lojban {
        pub mod nibli {
            ...
            pub mod gerna {
                ...
                pub type ParseResult = super::super::super::super::lojban::nibli::ast_types::ParseResult;
                    ...
                    match result1 {
                        Ok(e) => {
                            *ptr2.add(0).cast::<u8>() = (0i32) as u8;
                            let super::super::super::super::lojban::nibli::ast_types::ParseResult {
                                buffer: buffer3,
                                errors: errors3,
                            } = e;
                            let super::super::super::super::lojban::nibli::ast_types::AstBuffer {
                                selbris: selbris4,
                                sumtis: sumtis4,
                            ...
                            for (i, e) in vec15.into_iter().enumerate() {
                                ...
                                {
                                    use super::super::super::super::lojban::nibli::ast_types::Selbri as V14;
                                    match e {
                                        V14::Root(e) => {
                            ...
                            *ptr2
                            ...
                            for (i, e) in vec28.into_iter().enumerate() {
                                ...
                                {
                                    use super::super::super::super::lojban::nibli::ast_types::Sumti as V27;
                                    match e {
                                        V27::ProSumti(e) => {
                                            *base.add(0).cast::<u8>() = (0i32) as u8;
                                        ...
                                        V27::ModalTagged(e) => {
                                            *base.add(0).cast::<u8>() = (6i32) as u8;
                                            let (t21_0, t21_1) = e;
                                            use super::super::super::super::lojban::nibli::ast_types::ModalTag as V22;
                                            match t21_0 {
                                                V22::Fixed(e) => {
                                        ...
                                        V27::Restricted(e) => {
                                            ...
                                            *base.add(8).cast::<i32>() = _rt::as_i32(t23_0);
                                            let super::super::super::super::lojban::nibli::ast_types::RelClause {
                                                kind: kind24,
                            ...
                            *ptr2
                            ...
                            for (i, e) in vec36.into_iter().enumerate() {
                                ...
                                {
                                    use super::super::super::super::lojban::nibli::ast_types::Sentence as V35;
                                    match e {
                                        V35::Simple(e) => {
                                            *base.add(0).cast::<u8>() = (0i32) as u8;
                                            let super::super::super::super::lojban::nibli::ast_types::Bridi {
                                                relation: relation29,
                                        ...
                                        V35::Connected(e) => {
                                            *base.add(0).cast::<u8>() = (1i32) as u8;
                                            ...
                                            use super::super::super::super::lojban::nibli::ast_types::SentenceConnective as V34;
                                            match t32_0 {
                                                V34::GanaiGi => {
                                                    *base
                                                        .add(::core::mem::size_of::<*const u8>())
                            ...
                            *ptr2
                            ...
                            for (i, e) in vec40.into_iter().enumerate() {
                                ...
                                {
                                    let super::super::super::super::lojban::nibli::ast_types::ParseError {
                                        message: message38,
                                        line: line38,
                                        column: column38,
                                    } = e;
                        ...
                        Err(e) => {
                            *ptr2.add(0).cast::<u8>() = (1i32) as u8;
                            use super::super::super::super::lojban::nibli::error_types::NibliError as V48;
                            match e {
                                V48::Syntax(e) => {
                                    *ptr2
                                        .add(::core::mem::size_of::<*const u8>())
                ...
                #[doc(hidden)]
                macro_rules! __export_lojban_nibli_gerna_0_1_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "lojban:nibli/gerna@0.1.0#parse-text")] unsafe extern "C" fn
                        ...
                        "cabi_post_lojban:nibli/gerna@0.1.0#parse-text")] unsafe extern
                ...
                #[doc(hidden)]
                pub(crate) use __export_lojban_nibli_gerna_0_1_0_cabi;
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_gerna_component_impl {
    ($ty:ident) => {
        self::export!($ty with_types_in self);
    };
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::lojban::nibli::gerna::__export_lojban_nibli_gerna_0_1_0_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::lojban::nibli::gerna);
    };
}
#[doc(inline)]
pub(crate) use __export_gerna_component_impl as export;
// Component type section removed — gerna is a lib dependency of lasna, not a standalone component.
#[cfg(any())]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:lojban:nibli@0.1.0:gerna-component:encoded world"
)]
#[doc(hidden)]
...
t\x03\0>\x03\0\x1clojban:nibli/ast-types@0.1.0\x05\0\x01B\x05\x01r\x03\x07messag\
es\x04liney\x06columny\x04\0\x0dsyntax-detail\x03\0\0\x01o\x02ss\x01q\x04\x06syn\
tax\x01\x01\0\x08semantic\x01s\0\x09reasoning\x01s\0\x07backend\x01\x02\0\x04\0\x0b\
nibli-error\x03\0\x03\x03\0\x1elojban:nibli/error-types@0.1.0\x05\x01\x02\x03\0\0\
...
ojban:nibli/gerna@0.1.0\x05\x04\x04\0\"lojban:nibli/gerna-component@0.1.0\x04\0\x0b\
\x15\x01\0\x0fgerna-component\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0d\
