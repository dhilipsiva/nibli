...
| `nibli-import` | — | RDF Turtle / OWL import + fact export. **Zero production dependents** — wiring an entrypoint or removing it is tracked in `TODO.md` (the resolve-nibli-import bullet) | `lib.rs` |
